...
class PanucciGUI(object):
    ...
    def create_settings_dialog(self, w):
        ...
        vb.pack_start(check_button_factory(self.action_scrolling_labels))
        vb.pack_start(check_button_factory(self.action_lock_progress))
        vb.pack_start(check_button_factory(self.action_dual_action_button))

        vb.pack_start(gtk.Label('')) # Used as a spacer

        vb.pack_start(gtk.Frame('Playback'))
        vb.pack_start(check_button_factory(self.action_stay_at_end))
        vb.pack_start(check_button_factory(self.action_seek_back))
        ...
        for action in (self.action_play_mode_all,
                self.action_play_mode_single,
                self.action_play_mode_random,
                self.action_play_mode_repeat):
