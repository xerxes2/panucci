...
class PlaylistTab():
    def __init__(self, main, player):
        ...
        self.button_file = QtGui.QPushButton(_("Add File"))
        ...
        self.button_dir = QtGui.QPushButton(_("Add Folder"))
        ...
        self.button_remove = QtGui.QPushButton(_("Remove"))
        ...
        self.button_jump = QtGui.QPushButton(_("Jump to"))
        ...
        self.button_info = QtGui.QPushButton(_("Info"))
        ...
        self.button_clear = QtGui.QPushButton(_("Clear"))
